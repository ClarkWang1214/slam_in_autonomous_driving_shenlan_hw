    ...
    sad::evaluate_and_call(
        [&]() { // lambda匿名回调函数
            ...
            if (success) {
                ...
                pcl::io::savePCDFileBinaryCompressed("./data/ch7/icp_trans_cauchy_kernel.pcd", *source_trans);
    ...
    sad::evaluate_and_call(
        [&]() {
            ...
            if (success) {
                ...
                sad::CloudPtr source_trans(new sad::PointCloudType);
                pcl::transformPointCloud(*source, *source_trans, pose.matrix().cast<float>());
                // pcl::io::savePCDFileBinaryCompressed("./data/ch7/ndt_trans_cauchy_kernel.pcd", *source_trans);
