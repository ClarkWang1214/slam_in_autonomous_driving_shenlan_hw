...
/**
 * @description: 处理Livox固态雷达数据
 * @param {ConstPtr} &msg
 * @param {FullCloudPtr} &pcl_out
 * @return {*}
 */
...
void CloudConvert::Process(const sensor_msgs::PointCloud2::ConstPtr &msg, FullCloudPtr &pcl_out) {
    switch (lidar_type_) {
        case LidarType::OUST64: // ouster 64线
            Oust64Handler(msg);
            break;

        case LidarType::VELO32: // Velodyne 32线
            VelodyneHandler(msg);
            break;

        default:            // 其它的，归为错误类型，也可以继续加case
